...
"https://i.imgur.com/FhC4jXa.jpg",
   ...
   var callback = () => api.sendMessage({body:`I'm not sure what to do next \nSweet: 

${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/49.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/49.jpg"));  
