...
(async function () {
    ...
    if (!data.includes(event.threadID) && !adminBot.includes(event.senderID)) {
      ...
      if (event.body && event.body == `${prefix}request`) {
        ...
        return api.sendMessage(`✔ অ্যাঅ্য রিকোয়েস্ট অ্যাডমিন এর কাছে পাঠানো হয়েছে ♥️\n\n « ❰͟͞❰͟͞⸙͟͞SAIFUL⸙͟͟͞͞❱͟͞❱ »`, event.threadID);
      }
      if (event.body && event.body.startsWith(prefix)) return api.sendMessage(`⚠️ আপনার গ্রুপের বা ইনবক্স এর এপ্রভাল নাই SaiFul Vai এর CYBER-CAT Bot ব্যাবহার করতে হলে! আপনার আগে পারমিশন লাগবে। পারমিশন নিতে Saiful Vai কে ইনবক্স করুন অথবা 💫/request💫 কমান্ড টা ব্যাবহার করেন।\n\n${prefix}request\n\n✅\n\n𝐎𝐰𝐧𝐞𝐫 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤\nhttps://www.facebook.com/saifulislam713\n\n« ❰͟͞❰͟͞⸙͟͞SAIFUL⸙͟͟͞͞❱͟͞❱ »`, event.threadID);
    };
    switch (event.type) {
      case "message":
      case "message_reply":
